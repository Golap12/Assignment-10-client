...
const HomeCard = ({ item }) => {
    ...
    return (
        ...
        <Link to={`/matchCategory/${item.subcategory_Name}`}>
            ...
            <Zoom>
            <div id="card" className=" rounded-lg overflow-hidden shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] ">
                ...
                <div className="p-4 text-center">
                    <h3 className="text-xl text-gray-200 font-bold mb-2">{item.subcategory_Name}</h3>
                </div>
            </div>
            </Zoom>
