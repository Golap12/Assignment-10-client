            ...
            <div className="p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
                ...
                <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-3 bg-gray-100 w-full lg:sticky top-0 text-center p-8">
                        <img src={hData.imageURL} alt="Product" className="w-2/4 rounded object-cover" />
                        <hr className="border-white border-2 my-6" />
                    </div>

                    <div className="lg:col-span-2">
                        <h2 className="text-2xl font-extrabold text-gray-800 mb-2">{hData.item_name}</h2>
                        <h2 className="text-lg font-extrabold text-gray-800">Sub Category : <span className="text-gray-600">{hData.subcategory_Name}</span></h2>
                        <div className="flex flex-wrap gap-4 mt-4">
                            <p className="text-gray-800 text-xl font-bold">${hData.price}</p>
                        </div>
