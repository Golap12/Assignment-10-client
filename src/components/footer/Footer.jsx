...
const Footer = () => {
    return (
        <footer className="mt-10 divide-y bg-red-100 rounded-t-[20px]">
            <div className=" container px-4 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold text-red-500">Gravo</span>
                    </a>
                </div>
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <div className="uppercase  text-xl font-bold text-red-500">Social media</div>
