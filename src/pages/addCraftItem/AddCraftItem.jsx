...
const AddCraftItem = () => {
    ...
    const handleAdd = (e) => {
        ...
        const newAddItem = {
            subcategory_Name, item_name, shortDescription, price, rating, customization, processing_time, stockStatus, photoURL,email
        }
                ...
                <form onSubmit={handleAdd}>
                    ...
                    <div className="flex mb-4 gap-5 justify-between">
                        <div className="w-full">
                            ...
                            <input placeholder={user?.displayName} type="text" id="userName" name="userName" className="w-full p-2 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
                        </div>
                        <div className="w-full">
